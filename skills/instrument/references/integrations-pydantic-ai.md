...
to pass. It says to name every agent, to use one `Instrumentation`
...
Page: `python/docs/integrations/pydantic-ai.md` in https://github.com/convergent-technologies/convergent-sdk.
